...
def main(args):
    ...
    # load test images 
    testdata = datasets.TestData(args.inputpath, iscrop=args.iscrop, scale=args.scale, face_detector=args.detector, sample_step=args.sample_step)
    ...
    for i in tqdm(range(len(testdata))):
        ...
        if args.saveImages:
            for vis_name in ['inputs', 'rendered_images', 'albedo_images', 'shading_images', 'shape_images',
                             'shape_detail_images', 'landmarks2d', 'landmarks3d']:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder', default='TestSamples/examples/reconstruct_results', type=str,
    ...
    parser.add_argument('--scale', default=1.0, type=int,
                        help='the scale for resizing images')
