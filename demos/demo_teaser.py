...
def main(args):
    ...
    for i in tqdm(range(len(testdata))):
        ...
        ### write gif
        with imageio.get_writer(os.path.join(savefolder, name + '_teaser.gif'), mode='I') as writer:
            for i in range(len(yaw_list)):
                grid_image_all = deca.visualize(visdict_list[i])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder', default='TestSamples/examples/teaser_results', type=str,
